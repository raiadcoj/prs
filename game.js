...
function gameRound(playerSelection,computerSelection){
    ...
    else if (playerSelection == "paper" && computerSelection == "scissors" || playerSelection == "rock" && computerSelection == "paper" || playerSelection == "scissors" && computerSelection == "rock") result = "You Lose!"
    else result = "You Win!"
